...
export const remix_voice = {
    name: 'remix_voice',
    description: 'Remix a quoted voice note to change its style or emotion. REQUIRES quoting a voice note. The tool will: 1. Clone the voice from the audio 2. Transcribe the content 3. Generate a new version with the requested style.',
    usage: [
