...
const agentTools = {
  ...
  search_web: {
    declaration: {
      name: 'search_web',
      description: 'חפש מידע באינטרנט ושלח לינקים/קישורים. **חובה להשתמש בכלי הזה** כאשר: המשתמש מבקש לינק/קישור/URL ("שלח לינק ל...", "תן לי קישור ל...", "send me a link to...", "give me URL for..."), או כשאתה צריך מידע עדכני שאינו זמין בידע שלך. הכלי מחזיר תוצאות עם לינקים ישירים!',
      parameters: {
        type: 'object',
        properties: {
          query: {
  ...
  create_music: {
    declaration: {
      name: 'create_music',
      description: 'צור שיר/מוזיקה חדש עם מילים (יוצר שיר מאפס). משתמש ב-Suno AI. **אל תשתמש בכלי הזה** אם המשתמש מבקש לינק/קישור לשיר קיים - במקרה זה השתמש ב-search_web! השתמש בכלי הזה רק כשמבקשים ליצור/לכתוב/להלחין שיר חדש.',
      parameters: {
        type: 'object',
        properties: {
          prompt: {
