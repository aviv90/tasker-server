/**
 * Prompt Utility Functions (TypeScript)
 */

export function simplifyPrompt(prompt?: string | null): string | null | undefined {
...
export function makePromptMoreGeneric(prompt?: string | null): string | null | undefined {
  if (!prompt) return prompt;
...
export function shouldSplitTask(_prompt?: string | null): boolean {
  return false;
}
