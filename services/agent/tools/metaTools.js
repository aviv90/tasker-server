...
// Import meta tool categories
const contextAndMemoryTools = require('./meta/contextAndMemoryTools');
const fallbackTools = require('./meta/fallbackTools');

// Combine all meta tools
const metaTools = {
