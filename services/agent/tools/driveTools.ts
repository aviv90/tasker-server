...
1. **חיפוש מסמכים** - המשתמש מבקש מידע מתוך מסמכים ב-Google Drive (דוגמאות: "חפש במסמכים שלי", "מה כתוב במסמך X", "מצא מידע על Y בתיקייה")
2. **חיפוש תמונות** - המשתמש מבקש מידע מתוך תמונות ב-Google Drive (דוגמאות: "מה יש בתמונה X", "חפש תמונות של Y")
3. **חיפוש בתיקייה ספציפית** - המשתמש מציין תיקייה מסוימת (דוגמאות: "חפש בתיקייה X", "מה יש בתיקייה Y")
4. **מידע מתוך קבצים** - המשתמש מבקש מידע שצריך לחפש בתוך תוכן הקבצים, לא רק בשמות הקבצים
