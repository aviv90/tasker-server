...
async function generateTextResponse(prompt, conversationHistory = []) {
  try {
    ...
    const messages = [
      {
        role: 'system',
        content: 'אתה עוזר AI מ-WaSender שמשיב הודעות אוטומטיות. אתה מועיל, יצירתי, חכם ומאוד ידידותי. אתה תמיד נותן תשובה. אתה מסוגל לענות בעברית ובאנגלית ואתה זוכר את השיחה הקודמת.'
      }
    ];
